...
if __name__ == "__main__":
    ...
    # Test calculations
    cutting_speed = calculator.calculate_turning("Cutting speed", 120, 100)
    print("Cutting Speed:", cutting_speed)

    spindle_speed = calculator.calculate_turning("Spindle speed", 100, 50)
    print("Spindle Speed:", spindle_speed)

    triangle_mass = calculator.calculate_material_mass("triangle", calculator.material_density["Karbon"], 3, 4, 100)
    print("Triangle Mass:", triangle_mass)

    table_feed = calculator.calculate_milling("Table feed", 0.1, 100, 3)
    print("Table Feed:", table_feed)
